...
<div id="page" class="main-content w-full max-w-full">
	<a class="skip-link screen-reader-text" href="#primary"><?php esc_html_e( 'Skip to content', 'netbiz' ); ?></a>
	 ...
	 *
	 * @hooked get_page_featured_section - 20
	 * (outputs Breadcrumbs)
	 */
	do_action( 'netbiz_after_header' );
	?>
